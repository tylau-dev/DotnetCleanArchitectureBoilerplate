...
_Hot tier — open items only. Resolved decisions are archived in `pending_decisions_archive.md`
(cold tier, not read by default)._

## Summary
4 open items below; otherwise all major architectural decisions have been confirmed.
